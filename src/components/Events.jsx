...
const Events = () => {
  ...
  const handleFilter = (searchQuery, eventType) => {
    ...
    if (eventType && eventType !== "Both") {
      filtered =
        eventType === "Online"
          ? filtered.filter((event) => event.isOnline === true)
          : filtered.filter((event) => event.isOnline === false);
    }
    if (searchQuery) {
      ...
      filtered = filtered.filter(
        (event) =>
          ...
          event.eventTags.some((tag) => searchRegex.test(tag))
      );
    }
